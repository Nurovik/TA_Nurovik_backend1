...
<div class="content-wrapper">
             <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Buat Liga Baru</h4>
<!--                  <p class="card-description">
                  ...
                  <!--<form class="forms-sample"  method = "post" action="fileuploadservlet" enctype="multipart/form-data">-->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="namaliga" id="exampleInputName1" placeholder="Nama Liga" required="">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Jumlah Team</label>
                       <input type="number" class="form-control" name="jumlahteam" id="exampleInputName1" placeholder="Jumlah Team" required="">
                    </div>
