 ...
 * @author teguh
 */
public class CmsPemainController extends HttpServlet {
      ...
      RequestDispatcher rd;
        try {
             ...
             if(RESPONSE.getStatusCode().equals("01")){
              ...
              rd = request.getRequestDispatcher("Views/cms/Pemain.jsp");
            ...
            Logger.getLogger(CmsPemainController.class.getName()).log(Level.SEVERE, null, e);
        }   finally {            
            out.close();
        }
    }
