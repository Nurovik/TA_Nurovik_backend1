...
<div class="content-wrapper">
             <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">EDIT Pemain</h4>
<!--                  <p class="card-description">
                  ...
                  <input type="hidden"  name="idpemain" value="${idpemain}"/>
                  <input type="hidden"  name="image" value="${image}"/>
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Liga</label>
                      <input type="text" class="form-control" name="namapemain" id="exampleInputName1" placeholder="namapemain" value="${namapemain}">
                    </div>
                       <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nopunggung" id="exampleInputName1" placeholder="nopunggung" value="${nopunggung}">
                    </div>
