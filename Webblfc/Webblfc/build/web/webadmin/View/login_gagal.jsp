<%-- 
    Document   : login
    Created on : Nov 18, 2021, 7:49:03 PM
    Author     : teguh
--%>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <!--<img src="webadmin/images/logo.svg" alt="logo">-->
              </div>
              <h4>Hello! let's get started</h4>
              <h6 class="font-weight-light">Sign in to continue.</h6>
              <%String message= (String)request.getAttribute("message"); %>
              <p class="login-box-msg"><font color=red><%= message%> </color></p>
              <form class="pt-3" action="LoginController">
...
<!--                      <input type="checkbox" class="form-check-input">
                ...
                <div class="mb-2">
                  <a href="CmsNewsController" class="btn btn-block btn-facebook auth-form-btn">
                    <i class="ti-back-left"></i>Back To CMS
                  </a>
                </div>
