<%-- 
    Document   : NewsId
    Created on : Oct 27, 2021, 10:06:56 PM
    Author     : teguh
--%>
         ...
         <div class="row">
            <div class="container">
               <div class="col-md-9">
                   ...
                   <% int news_id = (int)request.getAttribute("news_id"); %>
                   <% String title = (String)request.getAttribute("title"); %>
                   <% String content = (String)request.getAttribute("content"); %>
                   <% String image = (String)request.getAttribute("image"); %>
                   <% 
                    
                       long  datepost = (long)request.getAttribute("datepost");
                       
                       
                        ConvertDate convert = new ConvertDate();
                        String date = convert.convertlongtodatenews(datepost);
                   %>
                   <% String userpost = (String)request.getAttribute("userpost"); %>
                   <% String baseurlcms = (String)request.getAttribute("baseurlcms"); %>
                      ...
                      <div class="news-post-widget">
                        ...
                        <img class="img-responsive" src=<%= baseurlcms+image%> alt="">
