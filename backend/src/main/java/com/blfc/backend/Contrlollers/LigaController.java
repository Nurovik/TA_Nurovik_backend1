...
public class LigaController {
    ...
    public Map<String,Object> GetAll(){
        ...
        listLiga = ligaService.getAll();


        if(listLiga.size()>0){

            response.put(Constants.LIST, listLiga);
    ...
    public Map<String,Object> GetByid(
        ...
        mliga = ligaService.getById(id);


        if(mliga != null){

            response.put(Constants.DATA_KEY, mliga);
            response.put(Constants.STATUS, Constants.SUCCESS);
            response.put(Constants.STATUS_CODE, Constants.SUCCESS_CODE);
    ...
    public Map<String, Object> saveliga(
            ...
            @RequestParam("jumlahteam")  String jumlahteam,
        ...
        oke= ligaService.saveliga(namaliga,Integer.parseInt(jumlahteam),file);
    ...
    public Map<String, Object> updateliga(
        ...
        oke= ligaService.updateliga(idliga,namaliga,Integer.parseInt(jumlahteam),file);
    ...
    public Map<String, Object> updateliganomedia(
        ...
        mliga = gson.fromJson(jsonString, Liga.class);

        int oke ;

        oke= ligaService.updateligaomedia(id,mliga.getNamaliga(), mliga.getJumlahteam(), mliga.getLogo());
    ...
    public Map<String, Object> DeleteLiga (
        ...
        new Liga();
        Liga cekid;
        cekid = ligaService.getById(id);

        if (cekid != null) {
            oke = ligaService.deleteliga(id);
            if (oke > 0) {
